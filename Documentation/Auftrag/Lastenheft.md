...
Leitbild
Wir sind eine berufsbildende Pflichtschule, die Techniker/innen ausbildet und der rasanten Entwicklung dieser Berufe Rechnung trägt.
Mit modernen Unterrichtsmethoden und Lehrmitteln sowie technisch sehr gut ausgestatteten Arbeitsräumen und Laboratorien werden unsere Schüler/innen zum erfolgreichen Lehrabschluss geführt.

#### Beschreibung und Hintergründe des Projektpraktikums

Das Lastenheft mit allen dazugehörigen Ausführungen ist die Grundlage des positiven Projektabschlusses und bildet gleichzeitig die Voraussetzungen für einen positiven Lehrabschluss.

- technisches Ziel ist eine Softwareumgebung mit nachstehenden Anforderungen
- Budgetvorgabe: sie nutzen die vorhandene Hardware/Software und Zeit – Nullbudget
- zusätzlich können Sie auf eigene Kosten Hardware/Software und Zeit investieren
- damit ein positiver Lehrabschluss gewährleistet werden kann, müssen Sie in der Lage sein, ein Front-end (Web-App, Desktop-App, Mobile-App), ein Backend (C#, PHP, Java ,usw.) mit einer relationalen Datenbankanbindung bereitzustellen
- die Dokumentationen des Projektes durchführen (Pflichtenheft, Projekthandbuch, Benutzerhandbuch, Quellcodedokumentation, …)
- Bereitstellung der Applikation (Funktionalitäten, Umgebung, …)
- eine Präsentation über den Projektverlauf und des Ergebnisses durchführen

### Produktübersicht und Einsatz

#### Aktuelle Situation

Derzeit gibt es keine zentrale Plattform, die es ermöglicht, personalisierte Informationen sicher und effektiv aus verschiedenen Datenquellen auszuwerten und zu visualisieren. Ihr Projekt soll nicht nur individuelle Daten-analysen und Berichte ermöglichen, sondern auch höchste Sicherheitsstandards erfüllen. Es muss sicherge-stellt werden, dass nur autorisierte Benutzer auf sensible Informationen zugreifen können.
Wir wollen

#### Beschreibung des Soll-Konzepts

Es wird eine Plattform mit Frontend (grafische Oberfläche mit Authentifizierung, Personalisierung und Filter-funktionen) sowie ein Backend mit Anbindung einer relationalen Datenbank zur Bereitstellung von Informatio-nen benötigt.
...
- Datenbankmodell (ERM)
- mindestens 5 unabhängige Tabellen
- referentielle Integrität der Datenbank (PK-FK)

##### Backend

- PHP, C#, C++, Python, Java, Node.js, Kotlin, Go usw.
...
- TypeScript, React, Angular, JavaScript, …
  ...
  - personalisierte Informationen anzeigen
  - Filterfunktionen der bereitgestellten Informationen

##### Quellcodeverwaltung

- GitHub, Bitbucket, … (Tagesaktuell) – Projektbetreuer bekommt Leserechte!
generierte Quellcodedokumentation
Benutzerhandbuch der Applikation

#### Funktionale Anforderungen

- Benutzeroberfläche mit Authentifizierung und Personalisierung
- Suchfunktion und Filtermöglichkeiten
- Lesen, schreiben, löschen und verändern von Informationen in der Datenbank (CRUD)
- Backend mit servergestützter Sprache

#### Nichtfunktionale Anforderungen (Leistungen, Daten)

Beispiel: Ressourcenverbrauch oder Zeitverhalten
...
- Serverdienste lokal
- bei mobilen Anwendungen muss die Möglichkeit vorhanden sein, die Clientsoftware für
 Android und IOS nativ zu kompilieren
- eine WebView ist keine native mobile Applikation

#### Projektverlauf

- Kommunikation zwischen den Projektmitgliedern
- wöchentliche Besprechungen mit Dokumentation
- wöchentliche Planungen (agiles Board, DevOps, …), Leserechte für Projektbetreuer
